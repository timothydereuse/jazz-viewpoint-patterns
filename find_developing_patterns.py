...
log_lh_cutoff = 1.7
top_motifs = 15
keys = ['durs', 'rough_contour', 'long_durs', 'melodic_peaks']
match_weights = [0, -7]
gap_penalties = [-5, -5, -4, -4]

xml_root = r'.\parker_transcriptions'
fnames = ['parker_transcriptions\\1947 02 01 Home Cookin\' 2 YouTube.mxl',
...
def filter_neighborhoods(motif_inds, dist_matrix, sqs):
...
for fname in fnames:
    ...
    motif_labels = filter_neighborhoods(motif_inds, dist_matrix, sqs)
